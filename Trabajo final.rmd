...
for (i in 1:numero_muestras){
  ...
  comando_align <- paste0("hisat2 -x",ubicacion_genome," ","-U"," ",nombres_archivos, " ", "-S", " ","Resultados/",nombre_de_muestra,".sam", " ","--un"," ","Resultados/",nombre_unaligned, " ", "-p"," ", numero_threads)
...
lista_archivos_sam <- unique(gsub("-unaligned","",lista_archivos_sam))
